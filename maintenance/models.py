...
class UserProfile(models.Model):
    ...
    # Manager approval: None = not requested, False = pending, True = approved
    ...
    @property
    def is_pending_manager(self):
        return self.role == 'manager' and self.manager_approved is False

    @property
    def is_approved_manager(self):
        return self.role == 'manager' and self.manager_approved is True
...
class Assignment(models.Model):
    ...
    technician    = models.ForeignKey(
        ...
        limit_choices_to={'userprofile__role': 'technician'}
    )
